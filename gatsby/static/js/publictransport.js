// OnDocumentReady function: https://stackoverflow.com/questions/9899372/pure-javascript-equivalent-of-jquerys-ready-how-to-call-a-function-when-t
...
docReady(function() { 
  ...
  document.addEventListener('click', function (event) {
    if (!event.target.matches('#visualization-start-content')) return;
  ...
  map.on('load', function() {
    d3.csv('/data/train5.csv', function(data) {
      ...
      document.getElementById('visualization-start-content').innerHTML = `<span style="pointer-events:none;">Start animation</span>`
    })
  })
})